...
public class ModifySAXParser extends DefaultHandler {
	   ...
	   public static void main(String args[]) {
	      ...
	      try {	
	         File inputFile = new File("modifyDomInput.xml");
	         ModifySAXParser obj = new ModifySAXParser();
